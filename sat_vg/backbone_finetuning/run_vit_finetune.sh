...
mkdir -p /home/pokle/Trans-VG/sat_vg/backbone_finetuning/checkpoints/vit_finetune
mkdir -p /home/pokle/Trans-VG/sat_vg/backbone_finetuning/logs/vit_finetune
...
python -m sat_vg.backbone_finetuning.train_vit 